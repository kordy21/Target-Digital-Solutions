  ...
  return (
    <div className="w-full relative">
      ...
      <motion.div 
        ...
        className="opacity-40 dark:opacity-20 absolute pointer-events-none z-0 hidden md:block top-10 right-10 h-40 md:h-64 will-change-transform"
      >
      ...
      <motion.div 
        ...
        className="opacity-40 dark:opacity-20 absolute pointer-events-none z-0 hidden md:block bottom-10 left-10 h-32 md:h-48 rotate-180 will-change-transform"
      >
        <Image src={Bubbles} alt="Bubbles" className="h-full w-auto object-contain" />
      </motion.div>
