  ...
  return (
    <section className="w-full relative px-6 md:px-18">
      ...
      <motion.div 
        ...
        className="opacity-40 dark:opacity-20 absolute pointer-events-none z-0 hidden md:block top-10 -right-5 h-40 md:h-64 rotate-180 will-change-transform"
      >
      ...
      <motion.div 
        ...
        className="opacity-40 dark:opacity-20 absolute pointer-events-none z-0 hidden md:block bottom-1/4 left-0 h-32 md:h-48 -rotate-90 will-change-transform"
      >
        <Image src={Bubbles} alt="Bubbles" className="h-full w-auto object-contain" />
      </motion.div>
