        ...
        <div className="w-full md:w-1/2">
          <FadeIn direction="up">
            <form className="flex flex-col gap-4 font-cairo" onSubmit={(e) => e.preventDefault()}>
              ...
              <Button type="submit" variant="outline" className="flex items-center gap-3 justify-center w-fit rounded-full px-8 h-12 font-cairo text-base border-primary text-black dark:text-white hover:bg-primary hover:text-primary-foreground group bg-transparent">
